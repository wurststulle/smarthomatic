...
parser_test("Packet Data: SenderID=20;PacketCounter=19285;MessageType=8;MessageGroupID=10;MessageID=4;MessageData=c4cc04332f80;Pressure=100769;Temperature=21.5;Humidity=38.0;");
